...
This tutorial teaches you how to trace individual cross-domain transactions between L1 Syscoin and Rollux using [the Optimism SDK](https://sdk.optimism.io/).
